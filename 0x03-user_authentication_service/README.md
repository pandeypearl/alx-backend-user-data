...
This project aims to cover the follwing concepts:
...
### 7. Register user
n this task, you will implement the end-point to register a user. Define a users function that implements the POST /users route.
